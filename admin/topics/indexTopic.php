                        ...
                        <tbody>
                            ...
                            <?php foreach($topics as $key => $topic): ?>
                                <tr>
                                    ...
                                    <td><a href="editTopic.php?id=<?php echo $topic['id'];?>" class="edit">edit</a></td> <!-- Vai chamar o editTopic.php para editar o topico escolhido -->
                                    <td><a href="indexTopic.php?del_id=<?php echo $topic['id']; ?> " class="delete">delete</a></td>
                                </tr>
